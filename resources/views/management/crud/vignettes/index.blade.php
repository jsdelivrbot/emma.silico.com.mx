                        ...
                        <div class="container-fluid">
                            <table class="table table-bordered table-stripped">
                                ...
                                @foreach($vignettes as $vignette)
                                    <tr class="text-left">
                                        <td><p class="badge">{{$vignette->id}}</p></td>
                                        <td>{!! $vignette->text !!}</td>

                                        <td>
                                            <a id="vignettes_{{$vignette->id}}" href="#!" class="btn btn-block btn-sm btn-info edit_button">Editar</a>
                                            {{ Form::open(array('route' => array('locations.destroy', $vignette), 'method' => 'delete')) }}
                            ...
                            <div class="well-sm">
                                ...
                                <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#createVignette">Crear nueva Viñeta</button>

                                {{-- link_to_action('LocationsController@create','Crear nueva locación',[],['class' => 'btn btn-lg btn-success']) --}}
                            </div>
                        </div>
                        <!-- Modal -->
                        <div id="createVignette" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Crear viñeta</h4>
                                    </div>
